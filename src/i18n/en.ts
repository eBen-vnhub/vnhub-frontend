export const en = {
  ...
  onboarding: {
    ...
    dashboard: {
      ...
      subtitle: "Master overview of all active vendor onboarding stages and statuses.",
      queueCount: "Queue",
      inProgressCount: "In Progress",
      reviewCount: "Review",
      doneCount: "Done",
      queueSection: "Queue — Awaiting VSM Assignment",
      noQueue: "No tickets in queue",
    ...
    status: {
      ...
      AWAITING_VENDOR_LISTING: "Awaiting Vendor Listing",
      VSM_REVIEW: "VSM Review",
      READY_FOR_OPS: "Pending Ops Assignment",
    ...
    labels: {
      ...
      generateAdmin: "Generate Admin Credentials",
    },
    toast: {
