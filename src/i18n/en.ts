export const en = {
  ...
  portal: {
    ...
    myBenefits: {
      ...
      planBenefits: "{{plan}} Plan Benefits",
  ...
  backoffice: {
    ...
    vendors: {
      ...
      noVendorsAvailable: "No Vendors Found",
      noVendorsStored: "Try adjusting your filters or search terms.",
  ...
  onboarding: {
    ...
    vsmTasksTitle: "Vendor Onboarding",
    ...
    dashboard: {
      ...
      subtitle: "Master overview of all vendor onboarding tickets.",
      queueCount: "Queue",
      inProgressCount: "In Progress",
      reviewCount: "Review",
      doneCount: "Done",
      queueSection: "Queue — Awaiting VSM Assignment",
      noQueue: "No tickets found matching criteria",
      recentlyCompleted: "Recently Completed",
      noCompleted: "No completed tickets yet",
      vsmActiveWorkload: "VSM Active Workload",
      opsActiveWorkload: "Ops Active Workload",
    ...
    status: {
      ...
      BENEFIT_IN_TESTING: "Benefit Testing",
      PENDING_GO_LIVE: "Pending Go Live",
      VSM_FINAL_REVIEW: "VSM Final Review",
      COMPLETED: "Completed",
    },
    actions: {
    ...
    labels: {
      ...
      setupLocation: "Setup Location / Branch",
      createFinance: "Create Financial Account",
      ...
      vendorListing: "Vendor Listing",
      benefitListing: "Benefit Listing",
      describeFix: "Describe what needs to be fixed...",
      requestRevision: "Request Revision",
      approveTest: "Approve Test",
      submitLiveLink: "Submit Live Link"
    },
    toast: {
      ...
      sendFormsError: "Failed to send form",
      reviewSuccess: "Review submitted",
      reviewError: "Failed to submit review",
      opsCompleteSuccess: "Vendor setup marked as complete",
      opsCompleteError: "Failed to complete setup",
      confirmSuccess: "Onboarding completed successfully!",
      confirmError: "Failed to complete onboarding",
      liveLinkSuccess: "Live link submitted",
      liveLinkError: "Failed to submit live link",
      testApproveSuccess: "Test approved",
      testApproveError: "Failed to approve test",
      testRejectSuccess: "Revision requested",
      testRejectError: "Failed to request revision",
    },
  },
  vendorPortal: {
    onboarding: {
  ...
  benefitTracker: {
    ...
    actions: {
      ...
      approveTest: "Approve Test",
      requestRevision: "Request Revision",
      approveLive: "Approve & Publish",
      rejectLive: "Request Changes",
    },
    toast: {
      ...
      uploadLiveFailed: "Failed to upload live link",
      reviewSuccess: "Review submitted",
  ...
  settings: {
    ...
    usersSubtitle: "Manage internal users, assign roles, and control access.",
