    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div className="bg-surface rounded-2xl border border-border p-4">
        ...
        {hqAddress ? (
          ...
          <div className="text-sm text-muted">No address provided</div>
        )}
      </div>

      <div className="bg-surface rounded-2xl border border-border p-4">
        <h4 className="text-xs font-bold text-brand uppercase tracking-wider mb-3 flex items-center gap-1.5">
          <Phone className="w-3.5 h-3.5" /> Company Phones
        </h4>
        {companyPhones ? (
          <div className="space-y-3">
            <div>
              <div className="text-[10px] uppercase text-muted font-semibold mb-1">Landline</div>
              <div className="text-sm font-medium text-main">
                {companyPhones.hqLandlineCountryCode} {companyPhones.hqLandlineNumber}
              </div>
            </div>
            <div>
              <div className="text-[10px] uppercase text-muted font-semibold mb-1">Mobile</div>
              <div className="text-sm font-medium text-main">
          ...
          <div className="text-sm text-muted">No phone info available</div>
        )}
      </div>
    </div>
  );
