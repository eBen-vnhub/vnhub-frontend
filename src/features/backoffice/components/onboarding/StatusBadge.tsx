...
const STATUS_COLORS: Record<TicketStatus, { bg: string; text: string; dot: string }> = {
  ...
  AWAITING_VENDOR_FORMS: { bg: 'bg-amber-50', text: 'text-amber-700', dot: 'bg-amber-400' },
  ...
  OPS_PROCESSING: { bg: 'bg-cyan-50', text: 'text-cyan-700', dot: 'bg-cyan-400' },
  IN_TESTING: { bg: 'bg-orange-50', text: 'text-orange-700', dot: 'bg-orange-400' },
  OPS_REVISION: { bg: 'bg-red-50', text: 'text-red-700', dot: 'bg-red-400' },
  PENDING_LIVE_LINK: { bg: 'bg-teal-50', text: 'text-teal-700', dot: 'bg-teal-400' },
  AWAITING_FINAL_VSM_APPROVAL: { bg: 'bg-emerald-50', text: 'text-emerald-700', dot: 'bg-emerald-400' },
