export const ar = {
  ...
  onboarding: {
    ...
    dashboard: {
      ...
      subtitle: "نظرة شاملة على جميع مراحل وحالات تسجيل الموردين النشطة.",
      ...
      noQueue: "لا توجد تيكتات في قائمة الانتظار",
    ...
    status: {
      ...
      AWAITING_VENDOR_LISTING: "بانتظار بيانات المورد",
      VSM_REVIEW: "مراجعة VSM",
      READY_FOR_OPS: "بانتظار تعيين العمليات",
