...
import DeleteConfirmationModal from '../../../components/portal/DeleteConfirmationModal';
  ...
  return (
    <>
        ...
        <div className={`grid grid-cols-1 ${canManageTeam ? 'lg:grid-cols-3' : ''} gap-8`}>
          <div className={canManageTeam ? 'lg:col-span-2' : ''}>
            <TeamMembersList
              ...
              isLoading={isLoading}
              currentUser={user}
              onRemove={canManageTeam ? (id) => setDeleteId(id) : undefined}
            />
          </div>
      ...
      <DeleteConfirmationModal
        ...
        title={t.portal.vendorAdmin.removeUser || 'Remove User'}
        message={t.portal.vendorAdmin.removeUserConfirm || 'Are you sure you want to remove this team member? They will lose access to this workspace.'}
      />
    </>
  );
}
